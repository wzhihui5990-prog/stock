#!/usr/bin/env python3
"""
将 qqq_market_data.xlsx 转换为可视化 HTML 页面（K线 + MA + 成交量 + MACD）
运行（在 stock/ 目录下）：python qqq/1-qqq日K/build_qqq_market_chart.py
输出：qqq/1-qqq日K/data/qqq_market_chart.html
"""
...
INPUT_FILE  = os.path.join(DATA_DIR, "qqq_market_data.xlsx")
OUTPUT_FILE = os.path.join(DATA_DIR, "qqq_market_chart.html")
...
def main():
    ...
    df_2min  = load_sheet(xls, "QQQ_分时2min")
    ...
    print(f"\n   用浏览器打开 qqq_market_chart.html 即可查看。")
