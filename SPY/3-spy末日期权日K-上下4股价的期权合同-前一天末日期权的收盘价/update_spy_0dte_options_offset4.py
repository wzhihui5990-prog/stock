# -*- coding: utf-8 -*-
"""
SPY 末日期权（0DTE）历史数据批量拉取（增量追加模式）
行权价偏移：±4 美元（相对T-1收盘价取整后 ±4）
数据来源：Polygon.io 免费 API

输出文件：data/spy_0dte_options_offset4.xlsx
...
END_DATE      = None
OUTPUT_DIR    = "data"
OUTPUT_FILE   = os.path.join(OUTPUT_DIR, "spy_0dte_options_offset4.xlsx")
